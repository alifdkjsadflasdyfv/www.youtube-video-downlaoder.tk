...
<head>
    ...
    <style>
        body {
            font-family: 'calibri', impact; background-color:#29e2f0;
        }
        .formSmall {
            width: 700px;
...
<table border=2 align=center id=table  bgcolor=#dee3e0><tr><td>
    ...
    <div class="container">
        <form method="post" action="" class="formSmall">
            <div class="row">
                <div class="col-lg-12">
                    <center><h7 style='font-family:lobster;' 'font-color:#0345fc;'><font color=#0345fc size=6> Download YouTube Video <br>Only For MP4 Videos</font></h7></center><br><br>
                </div>
                <div class="col-lg-12">
